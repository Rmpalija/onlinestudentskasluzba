...
@section('content')
    ...
    {!! Form::model($predmeti, ['method' => 'PUT', 'route' => ['admin.predmetis.update', $predmeti->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('fakulteti[]', $fakultetis, old('fakulteti') ? old('fakulteti') : $predmeti->fakulteti->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-fakulteti' , 'required' => '']) !!}
                    <p class="help-block"></p>
