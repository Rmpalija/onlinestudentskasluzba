...
<li role="presentation" class=""><a href="#users" aria-controls="users" role="tab" data-toggle="tab">KorisnicI</a></li>
</ul>
    ...
    <thead>
        <tr>
            <th>@lang('quickadmin.predmeti.fields.naziv')</th>
                        <th>@lang('quickadmin.predmeti.fields.uloga')</th>
            ...
            @foreach ($predmetis as $predmeti)
                <tr data-entry-id="{{ $predmeti->id }}">
                    <td field-key='naziv'>{{ $predmeti->naziv }}</td>
                                <td field-key='uloga'>{{ $predmeti->uloga->title ?? '' }}</td>
