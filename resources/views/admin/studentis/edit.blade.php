...
@section('content')
    ...
    {!! Form::model($studenti, ['method' => 'PUT', 'route' => ['admin.studentis.update', $studenti->id], 'files' => true,]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($studenti->slika)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$studenti->slika) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$studenti->slika) }}"></a>
                    @endif
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('predmeti[]', $predmetis, old('predmeti') ? old('predmeti') : $studenti->predmeti->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-predmeti' , 'required' => '']) !!}
                    <p class="help-block"></p>
