...
<li role="presentation" class=""><a href="#predmeti" aria-controls="predmeti" role="tab" data-toggle="tab">Predmeti</a></li>
...
<div role="tabpanel" class="tab-pane " id="predmeti">
...
{!! Form::open(array(
        ...
        @endif
            ...
            <a href="{{ route('admin.fakultetis.index') }}" class="btn btn-default">@lang('quickadmin.qa_back_to_list')</a>
        </div>
    </div>
@stop
