...
@section('content')
    ...
    {!! Form::model($profesori, ['method' => 'PUT', 'route' => ['admin.profesoris.update', $profesori->id], 'files' => true,]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($profesori->slika)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$profesori->slika) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$profesori->slika) }}"></a>
                    @endif
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('fakultet[]', $fakultets, old('fakultet') ? old('fakultet') : $profesori->fakultet->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-fakultet' , 'required' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('predmeti[]', $predmetis, old('predmeti') ? old('predmeti') : $profesori->predmeti->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-predmeti' ]) !!}
                    <p class="help-block"></p>
