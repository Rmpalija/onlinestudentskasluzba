...
@section('content')
    ...
    {!! Form::model($ispiti, ['method' => 'PUT', 'route' => ['admin.ispitis.update', $ispiti->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('fakultet[]', $fakultets, old('fakultet') ? old('fakultet') : $ispiti->fakultet->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-fakultet' , 'required' => '']) !!}
